...
public abstract class APIController {
    ...
    /**
     * Used to serialize data and messages to JSON for transmitting through the REST
     * API
     */
    ...
    /**
     * Turns the provided object into a JSON Tree
     *
     * @param obj The object to serialize
     * @return The resulting JSON String
     */
    static final protected JsonElement toJsonTree(final Object obj) {
    ...
    /**
     * Creates a JSONResponse for sending an error or informational message back to
     * the user.
     *
    ...
    /**
     * Creates a JSONResponse, setting the status to failed and the message to what
     * is provided.
     *
     * @param message The detailed message to send
     * @return The resulting JSON String
    ...
    /**
     * Creates a JSONResponse, setting the status to success and the message to what
     * is provided.
     *
     * @param message The detailed message to send
     * @return The resulting JSON String
    ...
    /**
     * Small class used for creating simple success/error messages to return via the
     * REST API. Contains a status of the action and an message.
     *
     * @author Kai Presler-Marshall
     *
     */
